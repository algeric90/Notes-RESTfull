class NoteItem extends HTMLElement {
  ...
  render() {
    const archiveColor = this._note.archived ? "btn-primary" : "btn-success";
    ...
    this.innerHTML = `
        ...
        `;
    this.querySelector(".note-item__delete-button").addEventListener(
      "click",
      () => this.deleteHandler(),
    );
    this.querySelector(".note-item__archive-button").addEventListener(
      "click",
      () => this.archiveHandler(),
    );
  }
